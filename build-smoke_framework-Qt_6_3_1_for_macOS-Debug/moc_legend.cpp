...
#include <memory>
#include "../smoke_framework/legend.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Legend_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Legend_t qt_meta_stringdata_Legend = {
    {
QT_MOC_LITERAL(0, 6), // "Legend"
QT_MOC_LITERAL(7, 15), // "onMessageLogged"
QT_MOC_LITERAL(23, 0), // ""
QT_MOC_LITERAL(24, 19), // "QOpenGLDebugMessage"
QT_MOC_LITERAL(44, 7) // "Message"

    },
    "Legend\0onMessageLogged\0\0QOpenGLDebugMessage\0"
    "Message"
};
...
const QMetaObject Legend::staticMetaObject = { {
    ...
    qt_meta_stringdata_Legend.offsetsAndSize,
    qt_meta_data_Legend,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Legend_t
, QtPrivate::TypeAndForceComplete<Legend, std::true_type>
, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QOpenGLDebugMessage const &, std::false_type>
