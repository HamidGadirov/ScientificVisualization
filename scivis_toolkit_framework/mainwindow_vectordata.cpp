...
void MainWindow::on_vectorDataComboBox_currentIndexChanged(int index)
{
    ...
    switch (index)
    {
        case 0: visualizationPtr->m_currentVectorDataType = VectorDataType::Velocity; break;
        case 1: visualizationPtr->m_currentVectorDataType = VectorDataType::ForceField; break;
    }
}
...
void MainWindow::on_vectorDataGlyphComboBox_currentIndexChanged(int index)
{
    ...
    switch (index)
    {
        case 0: visualizationPtr->m_currentGlyphType = Glyph::GlyphType::Hedgehog; break;
        case 1: visualizationPtr->m_currentGlyphType = Glyph::GlyphType::Triangle; break;
        case 2: visualizationPtr->m_currentGlyphType = Glyph::GlyphType::Cone; break;
        case 3: visualizationPtr->m_currentGlyphType = Glyph::GlyphType::Arrow2D; break;
        case 4: visualizationPtr->m_currentGlyphType = Glyph::GlyphType::Arrow3D; break;
    }
